...
// PlaceholderImage SDK utility type

class PlaceholderImageUtility
{
    ...
    public static function copy(PlaceholderImageUtility $src): PlaceholderImageUtility
    {
        $u = new PlaceholderImageUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
