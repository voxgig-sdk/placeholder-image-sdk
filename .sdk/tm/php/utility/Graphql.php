...
// PlaceholderImage SDK utility: graphql
//
...
class PlaceholderImageGraphql
{
    ...
    // equivalent.
    public static function body(PlaceholderImageContext $ctx): mixed
    {
    ...
    public static function errors(PlaceholderImageContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
