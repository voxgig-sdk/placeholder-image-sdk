...
// PlaceholderImage SDK utility: fetcher
...
class PlaceholderImageFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PlaceholderImageSDK/1.0)';
    ...
    public static function call(PlaceholderImageContext $ctx, string $fullurl, array $fetchdef): array
    {
