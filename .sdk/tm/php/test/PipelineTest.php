...
// PlaceholderImage SDK pipeline test
//
...
{
    private static function utility(): PlaceholderImageUtility
    {
        return new PlaceholderImageUtility();
    }
    ...
    private static function ctx(array $over = []): PlaceholderImageContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PlaceholderImageContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PlaceholderImageOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PlaceholderImageError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PlaceholderImageOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PlaceholderImageMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PlaceholderImageOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PlaceholderImageMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PlaceholderImageOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PlaceholderImageMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PlaceholderImageSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PlaceholderImageMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PlaceholderImageResponse([]),
            'result' => new PlaceholderImageResult([]),
        ]);
        [, $err] = PlaceholderImageMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PlaceholderImageSpec([]),
            'response' => null,
            'result' => new PlaceholderImageResult([]),
        ]);
        [, $err] = PlaceholderImageMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PlaceholderImageSpec(['step' => 's']),
            'response' => new PlaceholderImageResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PlaceholderImageResult([]),
        ]);
        [, $err] = PlaceholderImageMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PlaceholderImageSpec(['step' => 's']),
            'response' => new PlaceholderImageResponse(self::resp(200, ['v' => 1])),
            'result' => new PlaceholderImageResult([]),
        ]);
        [, $err] = PlaceholderImageMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PlaceholderImageSpec(['step' => 's']),
            'response' => new PlaceholderImageResponse(self::resp(200, ['v' => 2])),
            'result' => new PlaceholderImageResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PlaceholderImageMakeResponse::call($ctx);
    ...
    {
        $preset = new PlaceholderImageResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PlaceholderImageSpec([]),
            'response' => new PlaceholderImageResponse([]),
            'result' => new PlaceholderImageResult([]),
        ...
        [$got, $err] = PlaceholderImageMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PlaceholderImageResult([])]);
        [, $err] = PlaceholderImageMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PlaceholderImageSpec([]), 'result' => null]);
        [, $err] = PlaceholderImageMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PlaceholderImageSpec(['step' => 's']),
            'result' => new PlaceholderImageResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PlaceholderImageOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PlaceholderImageMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PlaceholderImageSpec(['step' => 's']),
            'result' => new PlaceholderImageResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PlaceholderImageOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PlaceholderImageMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PlaceholderImageResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PlaceholderImageSpec([]),
            'result' => new PlaceholderImageResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PlaceholderImageMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PlaceholderImageMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PlaceholderImageError('boom', 'boom');
        $utility->fetcher = function (PlaceholderImageContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PlaceholderImageSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PlaceholderImageMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PlaceholderImageContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PlaceholderImageMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PlaceholderImageResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PlaceholderImageMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PlaceholderImageContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PlaceholderImageSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PlaceholderImageMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PlaceholderImageResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PlaceholderImageSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PlaceholderImageMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PlaceholderImageMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PlaceholderImageMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PlaceholderImageResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PlaceholderImageDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PlaceholderImageResult(['ok' => false])]);
        $this->expectException(PlaceholderImageError::class);
        PlaceholderImageDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PlaceholderImageResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PlaceholderImageMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PlaceholderImageMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PlaceholderImageBaseFeature();
        $b = new PlaceholderImageBaseFeature();
        PlaceholderImageFeatureAdd::call($ctx, $a);
        PlaceholderImageFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PlaceholderImageBaseFeature
    {
        $f = new PlaceholderImageBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PlaceholderImageFeatureAdd::call($ctx, self::named_feature('a'));
        PlaceholderImageFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        PlaceholderImageFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        PlaceholderImageFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        PlaceholderImageFeatureAdd::call($ctx, $replace);
        ...
        PlaceholderImageFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PlaceholderImageContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PlaceholderImageSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PlaceholderImagePrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PlaceholderImagePrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PlaceholderImageResponse(['headers' => null]),
            'result' => new PlaceholderImageResult([]),
        ]);
        PlaceholderImageResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PlaceholderImageResultBody::call($ctx);
