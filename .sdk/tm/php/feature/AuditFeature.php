...
// PlaceholderImage SDK audit feature
...
class PlaceholderImageAuditFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _emit(PlaceholderImageContext $ctx, string $outcome): void
    {
