...
// PlaceholderImage SDK proxy feature
...
class PlaceholderImageProxyFeature extends PlaceholderImageBaseFeature
{
    ...
    public function init(PlaceholderImageContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PlaceholderImageContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
