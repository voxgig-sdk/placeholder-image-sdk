...
// PlaceholderImage SDK ratelimit feature
...
class PlaceholderImageRatelimitFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _acquire(PlaceholderImageContext $ctx): void
    {
    ...
    private function _track(PlaceholderImageContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
