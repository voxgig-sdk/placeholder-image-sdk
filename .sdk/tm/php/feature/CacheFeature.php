...
// PlaceholderImage SDK cache feature
...
class PlaceholderImageCacheFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _through(PlaceholderImageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
