...
// PlaceholderImage SDK netsim feature
...
class PlaceholderImageNetsimFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _simulate(PlaceholderImageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PlaceholderImageContext $ctx, array $applied): void
    {
        $client = $this->client;
