...
class PlaceholderImageTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PlaceholderImageTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PlaceholderImageTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PlaceholderImageTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
