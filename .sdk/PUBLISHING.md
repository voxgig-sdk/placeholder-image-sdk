...
|---|---|---|
| `ts/` | @voxgig-sdk/placeholder-image-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/placeholder-image-sdk \
      --repository voxgig-sdk/placeholder-image-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/placeholder-image-sdk` shows it, and
`npm trust revoke @voxgig-sdk/placeholder-image-sdk --id=<id>` removes it.
