...
local PlaceholderEntity = {}
PlaceholderEntity.__index = PlaceholderEntity


function PlaceholderEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PlaceholderEntity)
...
function PlaceholderEntity:get_name()
  return self._name
end


function PlaceholderEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PlaceholderEntity.new(self._client, opts)
end
...
function PlaceholderEntity:mark_deleted()
  self._deleted = true
end


function PlaceholderEntity:deleted()
  return true == self._deleted
end


function PlaceholderEntity:data_set(args)
  if args ~= nil then
...
function PlaceholderEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PlaceholderEntity:match_set(args)
  if args ~= nil then
...
function PlaceholderEntity:match_get()
...
function PlaceholderEntity:stream(action, args, callopts)
...
function PlaceholderEntity:_run_op(ctx, post_done)
  local utility = self._utility
