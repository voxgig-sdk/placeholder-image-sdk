...
local PlaceholderImageEntity = {}
PlaceholderImageEntity.__index = PlaceholderImageEntity


function PlaceholderImageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PlaceholderImageEntity)
  self._name = "placeholder_image"
  self._client = client
...
function PlaceholderImageEntity:get_name()
  return self._name
end


function PlaceholderImageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PlaceholderImageEntity.new(self._client, opts)
end
...
function PlaceholderImageEntity:mark_deleted()
  self._deleted = true
end


function PlaceholderImageEntity:deleted()
  return true == self._deleted
end


function PlaceholderImageEntity:data_set(args)
  if args ~= nil then
...
function PlaceholderImageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PlaceholderImageEntity:match_set(args)
  if args ~= nil then
...
function PlaceholderImageEntity:match_get()
...
function PlaceholderImageEntity:stream(action, args, callopts)
...
function PlaceholderImageEntity:_run_op(ctx, post_done)
  local utility = self._utility
