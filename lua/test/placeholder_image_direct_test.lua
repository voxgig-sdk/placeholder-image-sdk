...
describe("PlaceholderImageDirect", function()
  it("should direct-load-placeholder_image", function()
    local setup = placeholder_image_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-placeholder_image", setup.live and "live" or "unit")
...
function placeholder_image_direct_setup(mockres)
