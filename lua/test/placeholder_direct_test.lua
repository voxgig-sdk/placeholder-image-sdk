...
describe("PlaceholderDirect", function()
  it("should direct-load-placeholder", function()
    local setup = placeholder_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-placeholder", setup.live and "live" or "unit")
...
function placeholder_direct_setup(mockres)
