...
function runner.env_override(m)
  local live = runner.getenv("PLACEHOLDERIMAGE_TEST_LIVE")
  local override = runner.getenv("PLACEHOLDERIMAGE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PLACEHOLDERIMAGE_TEST_EXPLAIN")
