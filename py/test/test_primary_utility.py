...
from placeholderimage_sdk.utility.voxgig_struct import voxgig_struct as vs
from placeholderimage_sdk import PlaceholderImageSDK
from placeholderimage_sdk.core.spec import PlaceholderImageSpec
from placeholderimage_sdk.core.result import PlaceholderImageResult
from placeholderimage_sdk.core.response import PlaceholderImageResponse
from placeholderimage_sdk.core.operation import PlaceholderImageOperation
from placeholderimage_sdk.core.error import PlaceholderImageError
from placeholderimage_sdk.core import helpers
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return PlaceholderImageError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except PlaceholderImageError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = PlaceholderImageResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = PlaceholderImageSDK.test(None, None)
        ...
        class TestInitFeature(PlaceholderImageBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PlaceholderImageBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = PlaceholderImageSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = PlaceholderImageSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PlaceholderImageSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PlaceholderImageSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = PlaceholderImageOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PlaceholderImageSDK.test(None, setup_opts)
