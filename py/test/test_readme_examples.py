# PlaceholderImage SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PlaceholderImageSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PlaceholderImageSDK(...) and PlaceholderImageSDK.test(...) become
#      PlaceholderImageSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "placeholderimage_sdk"
_SDK_CLASS = "PlaceholderImageSDK"
