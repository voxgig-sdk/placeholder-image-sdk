...
from placeholderimage_sdk.core.helpers import get_ctx_prop, to_map
...
class PlaceholderImageContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = PlaceholderImageControl()
        ...
        if isinstance(sp, PlaceholderImageSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PlaceholderImageResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PlaceholderImageResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return PlaceholderImageOperation({})
    ...
    def make_error(self, code, msg):
        return PlaceholderImageError(code, msg, self)
