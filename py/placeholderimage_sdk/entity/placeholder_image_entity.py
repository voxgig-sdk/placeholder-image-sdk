...
from placeholderimage_sdk.placeholderimage_types import (
    PlaceholderImage,
...
class PlaceholderImageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PlaceholderImageEntity(self._client, opts)
    ...
    def data_get(self) -> PlaceholderImage:
    ...
    def match_get(self) -> PlaceholderImage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> PlaceholderImage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.PlaceholderImage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
