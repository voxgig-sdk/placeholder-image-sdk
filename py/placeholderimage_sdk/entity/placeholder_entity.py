...
class PlaceholderEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return PlaceholderEntity(self._client, opts)
    ...
    def match_get(self) -> Placeholder:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Placeholder:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Placeholder().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
