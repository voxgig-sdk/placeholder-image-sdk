...
from placeholderimage_sdk.utility import register

# Load features
from placeholderimage_sdk.feature.base_feature import PlaceholderImageBaseFeature
from placeholderimage_sdk.features import _has_feature, _make_feature
...
class PlaceholderImageSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PlaceholderImageUtility()
    ...
    def get_utility(self):
        return PlaceholderImageUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PlaceholderImageSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Placeholder(self, data=None) -> "PlaceholderEntity":
        ...
        from placeholderimage_sdk.entity.placeholder_entity import PlaceholderEntity
    ...
    def PlaceholderImage(self, data=None) -> "PlaceholderImageEntity":
        ...
        from placeholderimage_sdk.entity.placeholder_image_entity import PlaceholderImageEntity
