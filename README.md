...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/placeholder-image` | `npm install @voxgig-sdk/placeholder-image` |
| Python | `voxgig-sdk-placeholder-image` | `pip install voxgig-sdk-placeholder-image` |
| PHP | `voxgig-sdk/placeholder-image` | `composer require voxgig-sdk/placeholder-image` |
| Golang | `github.com/voxgig-sdk/placeholder-image-sdk/go` | `go get github.com/voxgig-sdk/placeholder-image-sdk/go` |
| Ruby | `voxgig-sdk-placeholder-image` | `gem install voxgig-sdk-placeholder-image` |
| Lua | `voxgig-sdk-placeholder-image` | `luarocks install voxgig-sdk-placeholder-image` |
