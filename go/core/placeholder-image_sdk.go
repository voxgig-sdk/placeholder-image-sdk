...
type PlaceholderImageSDK struct {
	Mode     string
...
func (sdk *PlaceholderImageSDK) OptionsMap() map[string]any {
...
func (sdk *PlaceholderImageSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PlaceholderImageSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PlaceholderImageSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PlaceholderImageSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PlaceholderImageSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PlaceholderImageSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PlaceholderImageSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PlaceholderImageSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PlaceholderImageSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PlaceholderImageSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *PlaceholderImageSDK {
	...
	sdk := NewPlaceholderImageSDK(sdkopts)
	sdk.Mode = "test"
