...
// instead of `sdk.NewPlaceholderImageSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *PlaceholderImageSDK  { return NewPlaceholderImageSDK(nil) }
func Test() *PlaceholderImageSDK { return TestSDK(nil, nil) }
