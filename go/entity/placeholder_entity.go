...
func NewPlaceholderEntity(client *core.PlaceholderImageSDK, entopts map[string]any) *PlaceholderEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlaceholderEntity) GetName() string { return e.name }
...
func (e *PlaceholderEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlaceholderEntity) Deleted() bool {
	return e.deleted
}


func (e *PlaceholderEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlaceholderEntity(e.client, opts)
}

func (e *PlaceholderEntity) Data(args ...any) any {
...
func (e *PlaceholderEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Placeholder; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlaceholderEntity) DataTyped(data ...Placeholder) Placeholder {
	if len(data) > 0 {
		return typedFrom[Placeholder](e.Data(asMap(data[0])))
	}
	return typedFrom[Placeholder](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Placeholder (all fields
// optional at the wire level).
func (e *PlaceholderEntity) MatchTyped(match ...Placeholder) Placeholder {
	if len(match) > 0 {
		return typedFrom[Placeholder](e.Match(asMap(match[0])))
	}
	return typedFrom[Placeholder](e.Match())
}
...
func (e *PlaceholderEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlaceholderEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlaceholderLoadMatch and returns an Placeholder. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlaceholderEntity) LoadTyped(reqmatch PlaceholderLoadMatch, ctrl map[string]any) (Placeholder, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Placeholder{}, err
	}
	return typedFrom[Placeholder](res), nil
}



func (e *PlaceholderEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PlaceholderEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlaceholderEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlaceholderEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlaceholderEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
