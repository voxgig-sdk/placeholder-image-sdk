...
type PlaceholderImageEntity struct {
	name    string
	client  *core.PlaceholderImageSDK
...
func NewPlaceholderImageEntity(client *core.PlaceholderImageSDK, entopts map[string]any) *PlaceholderImageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlaceholderImageEntity) GetName() string { return e.name }
...
func (e *PlaceholderImageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlaceholderImageEntity) Deleted() bool {
	return e.deleted
}


func (e *PlaceholderImageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlaceholderImageEntity(e.client, opts)
}

func (e *PlaceholderImageEntity) Data(args ...any) any {
...
func (e *PlaceholderImageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PlaceholderImage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlaceholderImageEntity) DataTyped(data ...PlaceholderImage) PlaceholderImage {
	if len(data) > 0 {
		return typedFrom[PlaceholderImage](e.Data(asMap(data[0])))
	}
	return typedFrom[PlaceholderImage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PlaceholderImage (all fields
// optional at the wire level).
func (e *PlaceholderImageEntity) MatchTyped(match ...PlaceholderImage) PlaceholderImage {
	if len(match) > 0 {
		return typedFrom[PlaceholderImage](e.Match(asMap(match[0])))
	}
	return typedFrom[PlaceholderImage](e.Match())
}
...
func (e *PlaceholderImageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlaceholderImageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlaceholderImageLoadMatch and returns an PlaceholderImage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlaceholderImageEntity) LoadTyped(reqmatch PlaceholderImageLoadMatch, ctrl map[string]any) (PlaceholderImage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return PlaceholderImage{}, err
	}
	return typedFrom[PlaceholderImage](res), nil
}



func (e *PlaceholderImageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PlaceholderImageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlaceholderImageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlaceholderImageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlaceholderImageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
