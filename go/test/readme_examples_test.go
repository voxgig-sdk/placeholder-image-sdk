...
const testSeed = `map[string]any{"entity": map[string]any{"placeholder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "placeholder_image": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
