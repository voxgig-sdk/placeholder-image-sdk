...
func TestPlaceholderImageEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		placeholderImageRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.placeholder_image")))
...
func placeholder_imageBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("PLACEHOLDER_IMAGE_TEST_PLACEHOLDER_IMAGE_ENTID")
	...
	idmapResolved := core.ToMapAny(env["PLACEHOLDER_IMAGE_TEST_PLACEHOLDER_IMAGE_ENTID"])
