...
require_relative 'PlaceholderImage_types'
...
class PlaceholderImageSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = PlaceholderImageHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = PlaceholderImageHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, PlaceholderImageFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    PlaceholderImageUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = PlaceholderImageHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = PlaceholderImageHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = PlaceholderImageHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    rescue PlaceholderImageError => err
    ...
    if fetched.is_a?(Hash)
      status = PlaceholderImageHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = PlaceholderImageError.new(
        "graphql_error", "PlaceholderImageSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = PlaceholderImageSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
