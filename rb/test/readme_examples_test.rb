...
#      offline in seeded test mode (PlaceholderImageSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PlaceholderImage_sdk.rb")
  SDK_CLASS = "PlaceholderImageSDK"
