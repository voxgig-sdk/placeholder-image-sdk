...
class PlaceholderImageEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PLACEHOLDERIMAGE_TEST_PLACEHOLDER_IMAGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def placeholder_image_basic_setup(extra)
  ...
  entid_env_raw = ENV["PLACEHOLDERIMAGE_TEST_PLACEHOLDER_IMAGE_ENTID"]
