...
// PlaceholderImage SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PlaceholderImageSDK::test)
...
{
    private const SDK_CLASS = 'PlaceholderImageSDK';
    ...
    private const SDK_BASE = 'placeholderimage_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../placeholderimage_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
