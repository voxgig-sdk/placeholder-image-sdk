...
class PlaceholderImageTestRunner
{
    ...
    {
        $live = self::getenv('PLACEHOLDER_IMAGE_TEST_LIVE');
        $override = self::getenv('PLACEHOLDER_IMAGE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('PLACEHOLDER_IMAGE_TEST_EXPLAIN');
...
class_alias('PlaceholderImageTestRunner', 'Runner');
class_alias('PlaceholderImageHelpers', 'Helpers');
