...
class PlaceholderImageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PLACEHOLDER_IMAGE_TEST_PLACEHOLDER_IMAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function placeholder_image_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PLACEHOLDER_IMAGE_TEST_PLACEHOLDER_IMAGE_ENTID");
