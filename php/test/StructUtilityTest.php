...
// PlaceholderImage SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PlaceholderImageOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PlaceholderImageOmni::structfix($now, Struct::undef()))
                        !== json_encode(PlaceholderImageOmni::structfix($val, Struct::undef()))) {
