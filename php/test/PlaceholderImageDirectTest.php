...
class PlaceholderImageDirectTest extends TestCase
{
    public function test_direct_load_placeholder_image(): void
    {
        $setup = placeholder_image_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-placeholder_image", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
