# PlaceholderImage PHP SDK Reference

Complete API reference for the PlaceholderImage PHP SDK.
...
#### `PlaceholderImageSDK::test($testopts = null, $sdkopts = null)`
...
Create a new `PlaceholderEntity` instance. Pass `null` for no initial data.
