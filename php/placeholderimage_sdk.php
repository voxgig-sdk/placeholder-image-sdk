...
class PlaceholderImageSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = PlaceholderImageHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = PlaceholderImageHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!PlaceholderImageFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, PlaceholderImageFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return PlaceholderImageUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = PlaceholderImageHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = PlaceholderImageHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = PlaceholderImageHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new PlaceholderImageError($op . "_allow",
                "PlaceholderImageSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = PlaceholderImageHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new PlaceholderImageError("graphql_error",
                "PlaceholderImageSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Placeholder($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_placeholder === null) {
                $this->_placeholder = new PlaceholderEntity($this, null);
            }
            return $this->_placeholder;
        }
        return new PlaceholderEntity($this, $data);
    }
    ...
    public function PlaceholderImage($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_placeholder_image === null) {
                $this->_placeholder_image = new PlaceholderImageEntity($this, null);
            }
            return $this->_placeholder_image;
        }
        return new PlaceholderImageEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new PlaceholderImageSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
