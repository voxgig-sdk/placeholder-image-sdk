...
// PlaceholderImage SDK metrics feature
...
class PlaceholderImageMetricsFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _record(PlaceholderImageContext $ctx, bool $ok): void
    {
