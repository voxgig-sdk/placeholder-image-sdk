...
// PlaceholderImage SDK timeout feature
...
class PlaceholderImageTimeoutFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _with_timeout(PlaceholderImageContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PlaceholderImageContext $_ctx, float $ms): void
    {
        $client = $this->client;
