...
// PlaceholderImage SDK rbac feature
...
class PlaceholderImageRbacFeature extends PlaceholderImageBaseFeature
{
    ...
    private function _required(PlaceholderImageContext $ctx): ?string
    {
    ...
    private function _reject(PlaceholderImageContext $ctx, string $required): void
    {
    ...
    private function _track(PlaceholderImageContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
