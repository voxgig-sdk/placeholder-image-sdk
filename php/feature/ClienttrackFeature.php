...
// PlaceholderImage SDK clienttrack feature
...
class PlaceholderImageClienttrackFeature extends PlaceholderImageBaseFeature
{
    ...
    public function PostConstruct(PlaceholderImageContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PlaceholderImage-SDK';
