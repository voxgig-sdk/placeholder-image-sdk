...
// PlaceholderImage SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PlaceholderImageTestFeature extends PlaceholderImageBaseFeature
{
    ...
    public function init(PlaceholderImageContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PlaceholderImageContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PlaceholderImageParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PlaceholderImageContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PlaceholderImageContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = PlaceholderImageParam::call($ctx, $k);
