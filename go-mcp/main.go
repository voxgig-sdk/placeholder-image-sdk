// Command PlaceholderImage-mcp is an MCP server exposing the PlaceholderImage
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PlaceholderImage_list  — list records of an entity
//	PlaceholderImage_load  — load a single record of an entity
//
