...
type Args struct {
	Entity string         `json:"entity" jsonschema:"placeholder | placeholder_image"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PlaceholderImageSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "placeholder-image_list",
		Description: "List records from PlaceholderImage. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "placeholder-image_load",
		Description: "Load a single record from PlaceholderImage. " +
...
func runOp(client *sdk.PlaceholderImageSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PlaceholderImageSDK, name string) (sdk.PlaceholderImageEntity, error) {
	switch strings.ToLower(name) {
	case "placeholder":
		return client.Placeholder(nil), nil
	case "placeholder_image":
		return client.PlaceholderImage(nil), nil
