...
function envOverride(m) {
    if ('TRUE' === process.env.PLACEHOLDER_IMAGE_TEST_LIVE ||
        'TRUE' === process.env.PLACEHOLDER_IMAGE_TEST_OVERRIDE) {
    ...
    m.PLACEHOLDER_IMAGE_TEST_EXPLAIN = process.env.PLACEHOLDER_IMAGE_TEST_EXPLAIN || m.PLACEHOLDER_IMAGE_TEST_EXPLAIN;
    return m;
}
