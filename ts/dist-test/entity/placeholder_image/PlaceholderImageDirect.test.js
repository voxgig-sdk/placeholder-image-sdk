...
(0, node_test_1.describe)('PlaceholderImageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-placeholder_image', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-placeholder_image', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['PLACEHOLDER_IMAGE_TEST_PLACEHOLDER_IMAGE_ENTID'];
...
//# sourceMappingURL=PlaceholderImageDirect.test.js.map