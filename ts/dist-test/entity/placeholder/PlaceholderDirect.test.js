...
(0, node_test_1.describe)('PlaceholderDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PlaceholderImageSDK({
    ...
    (0, node_test_1.test)('direct-load-placeholder', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-placeholder', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PLACEHOLDER_IMAGE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PlaceholderImageSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PLACEHOLDER_IMAGE_TEST_PLACEHOLDER_ENTID'];
    ...
    const client = new __1.PlaceholderImageSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=PlaceholderDirect.test.js.map