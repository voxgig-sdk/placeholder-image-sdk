...
(0, node_test_1.describe)('PlaceholderEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'placeholder.' + op, live))
                return;
        }
        ...
        let placeholder_ref01_data = Object.values(setup.data.existing.placeholder)[0];
        // LOAD
        const placeholder_ref01_ent = client.Placeholder();
        const placeholder_ref01_match_dt0 = {};
        const placeholder_ref01_data_dt0 = (await placeholder_ref01_ent.load(placeholder_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != placeholder_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/placeholder/PlaceholderTestData.json');
    ...
    let idmap = transform(['placeholder01', 'placeholder02', 'placeholder03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=PlaceholderEntity.test.js.map