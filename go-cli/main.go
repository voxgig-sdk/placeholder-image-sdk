// Command PlaceholderImage-cli is a CLI + REPL for the PlaceholderImage SDK,
...
const prompt = "placeholder-image"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "placeholder placeholder_image"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      PLACEHOLDER_IMAGE_APIKEY (api key), PLACEHOLDER_IMAGE_BASE (base url override)")
