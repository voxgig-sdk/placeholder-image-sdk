...
func registerSDKWords(r *eng.Registry, client *sdk.PlaceholderImageSDK) {
...
func runOp(client *sdk.PlaceholderImageSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
