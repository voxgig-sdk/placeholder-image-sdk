...
AQL-driven CLI and REPL for the PlaceholderImage SDK. Positional arguments are
...
```sh
go build -o placeholder-image-cli ./...
```
...
./placeholder-image-cli list placeholder
./placeholder-image-cli load 1 placeholder
./placeholder-image-cli load '{id:1}' placeholder
